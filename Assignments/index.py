...
# then prints out its binary representation and avoid printing leading zeros. (4 % )
# Obviously, we did it in class with a format string, but that is not allowed for this assignment.
# The program should cater for numbers up to 65535
# i.e. (2 ** 16) - 1
...
#  Once the program is working, modify it to print Octal rather than binary. (1 % )
